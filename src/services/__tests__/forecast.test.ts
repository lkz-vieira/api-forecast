...
import stormGlassNormalizedResponseFixture from '@test/fixture/stormglass_normalized_weather_3_hours.json'
...
describe('Forecast Service', () => {
  ...
  test('Caso tenha algum erro interno durante o processamento de ...', async () => {
    const beaches: Array<Beach> = [
      {
        lat: -33.792726,
        lng: 151.289824,
